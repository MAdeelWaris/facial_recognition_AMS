...
from student_management_app import views, HodViews, StaffViews, StudentViews, main
...
urlpatterns = [
    ...
    path('read_frames', HodViews.read_frames,name="read_frames"),
    ...
    path('detect_faces', StaffViews.detect_faces, name="detect_faces"),
